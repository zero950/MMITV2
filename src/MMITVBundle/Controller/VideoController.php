...
use MMITVBundle\Form\VideoType;
...
class VideoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('MMITVBundle:Video')->findAll();
     ...
     * @Method("POST")
     * @Template("MMITVBundle:Video:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('MMITVBundle:Video')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("MMITVBundle:Video:edit.html.twig")
     */
